...
if(NOT UNIX_STRUCTURE)
	...
	if(APPLE)
		set(OBS_RESOURCES_PATH "obs.app/Contents/Resources") # didn't exist
		set(OBS_DATA_DESTINATION "${OBS_RESOURCES_PATH}/data") # didn't exist

		set(OBS_EXECUTABLE_DESTINATION ".") # bin
		set(OBS_EXECUTABLE32_DESTINATION ".") # bin
		set(OBS_EXECUTABLE64_DESTINATION ".") # bin
		set(OBS_LIBRARY_DESTINATION "${OBS_RESOURCES_PATH}/bin") # bin
		set(OBS_LIBRARY32_DESTINATION "${OBS_RESOURCES_PATH}/bin") # bin
		set(OBS_LIBRARY64_DESTINATION "${OBS_RESOURCES_PATH}/bin") # bin
		set(OBS_PLUGIN_DESTINATION "${OBS_RESOURCES_PATH}/obs-plugins") # obs-plugins
		set(OBS_PLUGIN32_DESTINATION "${OBS_RESOURCES_PATH}/obs-plugins") # obs-plugins
		set(OBS_PLUGIN64_DESTINATION "${OBS_RESOURCES_PATH}/obs-plugins") # obs-plugins

		set(OBS_DATA_PATH "../data") # ../${OBS_DATA_DESTINATION}
	...
	set(OBS_CMAKE_DESTINATION "${OBS_RESOURCES_PATH}/cmake")
	set(OBS_INCLUDE_DESTINATION "${OBS_RESOURCES_PATH}/include")
...
function(install_obs_core target)
	...
	if("${ARGV1}" STREQUAL "EXPORT")
		...
		install(TARGETS ${target}
			LIBRARY DESTINATION "${OBS_LIBRARY_DESTINATION}"
			RUNTIME DESTINATION "${OBS_EXECUTABLE_DESTINATION}"
			BUNDLE DESTINATION ".") # didn't exist
	endif()
